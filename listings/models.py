...
class Listing(models.Model):
    realtor = models.ForeignKey(Realtor, on_delete=models.DO_NOTHING) #when foreign key is deleted, do nothing
    ...
    bathrooms = models.DecimalField(max_digits=2, decimal_places=1) #only 0.n
